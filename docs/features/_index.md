...
Per-feature requirements and descriptions. Each feature lives in its own directory with an
...
| [Interactive mode](interactive-mode/_index.md)       | `IM` | In progress | A long-running mode that renders a graphical overlay alongside the Notification Center UI, for picking a notification and acting on it. |
